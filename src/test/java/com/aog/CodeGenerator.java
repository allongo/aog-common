...
import com.aog.core.constant.ProjectConstant;
...
public class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://192.168.1.20:3306/coolook";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "coolook";
    ...
    // @author
    private static final String AUTHOR = "mingle";
    // @date
